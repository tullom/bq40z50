...
use crate::consts::{
    ...
    CHRG_VOLTAGE_OVERRIDE_SIZE_BYTES, LARGEST_BUF_SIZE_BYTES, LARGEST_REG_SIZE_BYTES, MAC_CMD, MAC_CMD_ADDR_SIZE_BYTES,
...
pub struct Bq40z50R3<I2C: I2cTrait, DELAY: DelayTrait> {
    pub device: Device<DeviceInterface<I2C, DELAY>>,
    capacity_mode_state: core::cell::Cell<CapacityModeState>,
}

impl<I2C: I2cTrait, DELAY: DelayTrait> Bq40z50R3<I2C, DELAY> {
